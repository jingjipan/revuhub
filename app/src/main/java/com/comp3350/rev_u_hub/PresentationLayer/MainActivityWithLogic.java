...
public class MainActivityWithLogic extends AppCompatActivity {

    private TextView mTextMessage;
    private SearchView movieSearch;
    private LogicInterface accessMovies;
...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accessMovies = InitializeBackend.createLogicLayer();
        ...
        movieSearch.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String movieName) {
                if(!accessMovies.getMovie(movieName).isEmpty()) {
                    ...
                    Toast.makeText(MainActivityWithLogic.this, "Movie not found", Toast.LENGTH_SHORT).show();
                }
                return true;
            }
